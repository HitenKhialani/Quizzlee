...
export default function QuizReport() {
  ...
  // Calculate time spent (mock data for demonstration)
  const getTimeMetrics = () => {
    const avgTimePerQuestion = Math.floor(Math.random() * 60) + 30; // 30-90 seconds
    const totalTime = avgTimePerQuestion * total;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div ref={reportRef} className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 text-white px-8 py-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-4">
                ...
                <h1 className="text-4xl font-bold tracking-tight">Quiz Performance Report</h1>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 inline-block mb-4">
                <p className="text-xl font-medium">{decodeURIComponent(lessonTitle || 'Quiz Assessment')}</p>
              </div>
          ...
          {/* Score Hero Section */}
          <div className="px-8 py-12 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-700">
            <div className="text-center mb-8">
              <div className={`inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br ${gradeInfo.color} shadow-2xl mb-6 relative`}>
                <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${gradeInfo.textColor}`}>{percentage}%</div>
                    <div className={`text-lg font-semibold ${gradeInfo.textColor}`}>{gradeInfo.grade}</div>
                  </div>
                </div>
                {isPassed && (
              ...
              <p className={`text-xl font-medium ${gradeInfo.textColor} mb-4`}>
                {gradeInfo.level} Performance
              </p>
              
              <div className={`inline-block px-6 py-3 rounded-full ${gradeInfo.bgColor} border-2 border-current/20`}>
                <div className="flex items-center space-x-2">
                  {isPassed ? (
                    <CheckCircle className={`h-5 w-5 ${gradeInfo.textColor}`} />
                  ) : (
                    <XCircle className={`h-5 w-5 ${gradeInfo.textColor}`} />
                  )}
                  <span className={`font-bold text-lg ${gradeInfo.textColor}`}>
                    {isPassed ? 'PASSED' : 'FAILED'}
                  </span>
                  {isPassed && <Award className={`h-5 w-5 ${gradeInfo.textColor}`} />}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 text-center hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-xs text-green-600 font-medium">{Math.round((correctAnswers / total) * 100)}%</div>
              </div>

              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 text-center hover:shadow-xl transition-all duration-300">
                <div className="bg-red-100 dark:bg-red-900/30 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-3">
                  <XCircle className="h-6 w-6 text-red-600" />
                </div>
                <div className="text-2xl font-bold text-red-600 mb-1">{incorrectAnswers}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Incorrect</div>
                <div className="text-xs text-red-600 font-medium">{Math.round((incorrectAnswers / total) * 100)}%</div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 text-center hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-2xl font-bold text-purple-600 mb-1">{timeMetrics.totalTime}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Time Spent</div>
                <div className="text-xs text-purple-600 font-medium">{timeMetrics.avgPerQuestion}/Q</div>
              </div>
            </div>
          </div>
